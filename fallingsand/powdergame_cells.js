...
const WATER = VISIBLE | MEDIUM_DENSITY | GRAVITY | FLUID | LOW_VISCOSITY | WATERING | REACT_NEIGHBOURS | (PILLAR_PLACE << PRODUCT_SHIFT) | IS_SOLIDIFIED;
...
const MAGMA = VISIBLE | HIGH_DENSITY | GRAVITY | HIGH_VISCOSITY | IGNITE | REACT_NEIGHBOURS | (FIRE_PLACE << PRODUCT_SHIFT) | SOLIDIFYING;
